...
print('***Actividad 3***')
nombre: str = input('Por favor, escriba su nombre: ')
apellido: str = input('Por favor, escriba su apellido: ')
edad: int = int(input('Por favor, indique su edad: '))
residencia: str = input('Por favor, indique su lugar de residencia: ')
...
print('***Actividad 5***')
segundos: int = int(input('Escriba una cantidad de segundos para obtener la equivalencia en horas: '))
...
print('***Actividad 6***')
numero: int = int(input('Indique un número: '))
...
print('***Actividad 7***')
numero1: int = int(input('Indique el primer número distinto de cero: '))
numero2: int = int(input('Indique el segundo número distinto de cero: '))
...
print('***Actividad 8***')
altura: float = float(input('Indique su altura: '))
peso: float = float(input('Indique su peso: '))
...
print('***Actividad 9***')
grados_celsius: float  = float(input('Indique los grados celsius para obtener su equivalencia en Fahrenheit: '))
temperatura_fahrenheit: float  = (grados_celsius * 1.8) + 32
...
# dichos números.
print('***Actividad 10***')
numero1: float  = int(input('Indique el primer número: '))
numero2: float  = int(input('Indique el segundo número: '))
numero3: float  = int(input('Indique el tercer número: '))
